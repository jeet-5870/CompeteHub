...
const filters = ['All', 'Beginner-friendly', 'Interview Prep', 'Olympiad'];
          ...
          <div className="flex flex-wrap gap-2 items-center">
            {filters.map(filter => (
              <button
                ...
                className={`px-3 py-1.5 rounded-full text-xs font-medium transition-colors border ${activeFilter === filter
